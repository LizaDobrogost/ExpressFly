...
namespace BusinessLayer.Services.Accounts
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<AccountModels> LoginAsync(AccountModels account)
        {
            ...
            return _mapper.Map<AccountModels>(dalAccount);
        }

        public async Task<AccountModels> ExternalLoginAsync(AccountModels account)
        {
            AccountEntity dalAccount = await _accountRepository.GetByEmailAsync(account.Email);
